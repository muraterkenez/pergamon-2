...
ALTER TABLE IF EXISTS animals DROP CONSTRAINT IF EXISTS valid_tag_number;
...
-- Add a more flexible constraint for tag number
ALTER TABLE animals ADD CONSTRAINT valid_tag_number_flexible
